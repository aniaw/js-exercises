describe('BuyController', function ()
{
    ...
    describe('initialization', function ()
    {
        ...
        {
            expect(buyCtrl.wallet).toEqual(WalletServiceMock.getWallet());
        });
    ...
    describe('buy', function ()
    {
        ...
        describe('when don\'t have enought money', function ()
        {
            beforeEach(function ()
            {
                buyCtrl.value = 1000;
            ...
            it('should set errorMessage id don\'t have enought money', function ()
            {
                expect(buyCtrl.errorMessage).toBe('Za mało środków');
            });
        });

        describe('when enought money to buy', function ()
        {
            var expectedWallet;
            beforeEach(function ()
            {
                ...
                expectedWallet = {
                    PLN: 1000 - (4.1635 * 100), EUR: 0, GBP: 0, USD: 100
                };
            ...
            it('should set new wallet', function ()
            {
                expect(WalletServiceMock.getWallet()).toEqual(expectedWallet);
            });
        });
